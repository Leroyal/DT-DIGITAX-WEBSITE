...
/**
* This function is used for fetch user marketing details(personal info)
*/
getMarketingDetails() {
console.log('userlist api');      
...
/**
* This function is used for save user marketing details(personal info)
...
/*
* This function is used for saving user consent details
* @params(array)
*/
...
/*
* This function is used for fetching user  consent details      
*/
